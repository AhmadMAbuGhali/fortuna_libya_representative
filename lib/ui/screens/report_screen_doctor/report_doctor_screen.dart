...
class ReportDoctorScreen extends StatelessWidget {
  ...
  ReportDoctorScreen({Key? key}) : super(key: key);
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: (){
            RouterClass.routerClass.navigateTo(NavegatorConstant.addReportDoctor);
          },
          tooltip: 'add Report',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        Row(
          children:   [
            Text('تقرير دكتور محمد سالم',style: getMediumStyle(color: ColorManager.black,fontSize: FontSize.s14),),
           const Spacer(),
             Visibility(
                 visible: task,
