...
class AddReportDoctorScreen extends StatelessWidget {
  ...
  AddReportDoctorScreen({Key? key}) : super(key: key);
  @override
        ...
        body: Padding(
          ...
          child: Column(children: [
            ...
            CustomTextFeild(
              ...
              hintText: 'قم بكتابة اسم الطبيب هنا'.tr(),
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'لا يمكن ان يكون الحقل فارغ'.tr();
                }
                return null;
              },
              textInputAction: TextInputAction.next,
              keyboardType: TextInputType.name, label: 'اسم الطبيب'.tr(),
            ),
